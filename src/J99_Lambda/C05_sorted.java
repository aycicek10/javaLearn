...
public class C05_sorted {
    ...
    public static void ciftKareKbPrint(List<Integer> sayi) {
        sayi.
                ...
                filter(C01_LambdaExpression::ciftMi).//akısdaki elemanlar cift sartıne göre filtrelendi
                map(t->t*t).//filtrelenen cift elemanlar karesine update edildi
                sorted().//akısdaki karesine update edilen eleman sıralandı(Natural Order)
