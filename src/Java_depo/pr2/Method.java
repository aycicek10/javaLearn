...
public class Method implements advancedJavaPractice.JavaProjects.P11_depoYonetimi.depoYonetimi06.GirisCikisInterface {
    ...
    static int id=1000;
    static HashMap<Integer, advancedJavaPractice.JavaProjects.P11_depoYonetimi.depoYonetimi06.UrunTanimlama> urunler=new HashMap<>();
    static int count=0;
    ...
    private static void urunTanimlama() {
        ...
        advancedJavaPractice.JavaProjects.P11_depoYonetimi.depoYonetimi06.UrunTanimlama urun=new advancedJavaPractice.JavaProjects.P11_depoYonetimi.depoYonetimi06.UrunTanimlama(id,urunIsmi,uretici,birim);
        urunler.put(id,urun);
        id++;
    ...
    public static void urunListele() {
        Set<Map.Entry<Integer, advancedJavaPractice.JavaProjects.P11_depoYonetimi.depoYonetimi06.UrunTanimlama>> urunlerSeti = urunler.entrySet();
