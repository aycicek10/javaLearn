...
// mdArray tanımlama
        int arr1[][]=new int[3][5];//üc katlı her katta 5 daireli bos apt -- 3 satır 5 sutun
        // bir sitede her birinde 10 dairelik 8 katlı 6 apt var. Nasıl array olarak tanımlanır.-- 3 boyutlu array
// trick *** ->> Array'ı uzunlukları ile tanımlamak  için inner(daire) uzunlukları esit olmalı
        int site[][][]=new int[6][8][10];
        // 24 kişilik 3 sınıf ve 21 kiişilik 5 sınıfı olan okul nasıl array olarak tanımlanır

        int sınıf24[][]=new int[3][24]; //24 kişilik 3 bos sınıf
        int sınıf21[][]=new int[5][21];// 21 kişilik 5 bos sınııf
...
arr1[0][3]=34; // 0. kat 3.daire değeri 34 atandı
        ...
        int arr[][]={
                ...
                {101}};//2.kat
        // 3 katlı apt
        // 101 eleman indexi nedir -> 2,0 - arr[2][0]
